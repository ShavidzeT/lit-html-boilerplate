...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lit_html_lib_lit_extended__ = __webpack_require__(2);
...
const input = __WEBPACK_IMPORTED_MODULE_0_lit_html_lib_lit_extended__["a" /* html */]`
  <input
    type=text
...
const myHTML = () => __WEBPACK_IMPORTED_MODULE_0_lit_html_lib_lit_extended__["a" /* html */]`
  <h2>Hello, ${state.name ? state.name : 'guest'}!</h2>
  ${input}
`

const renderApp = () => Object(__WEBPACK_IMPORTED_MODULE_0_lit_html_lib_lit_extended__["b" /* render */])(myHTML(), document.body)
